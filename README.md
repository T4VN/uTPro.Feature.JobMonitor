...
By [T4VN](https://github.com/T4VN). Free to use — including in commercial projects — under a proprietary [End User License Agreement](LICENSE.txt). The package ships as a compiled NuGet package; the source is not published, and modifying, reverse engineering, or redistributing the package is not permitted. See [LICENSE.txt](LICENSE.txt) for full terms. Issues welcome on the [GitHub repository](https://github.com/T4VN/uTPro.Feature.JobMonitor).
